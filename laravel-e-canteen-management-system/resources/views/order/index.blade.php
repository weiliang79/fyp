                                                ...
                                                @for($i = 0; $i < count($orders); $i++) <div class="accordion-item">
                                                      <h2 class="accordion-header" id="heading{{ $i }}">
                                                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse{{ $i }}" aria-expanded="false" aria-controls="collapse{{ $i }}">
                                                                  ...
                                                                  <div class="d-flex justify-content-between mx-4" style="width: 100%;">
                                                                        <div>Pick Up Time: {{ $orders[$i]->pick_up_start->format('Y-m-d H:i A') }} to {{ $orders[$i]->pick_up_end->format('Y-m-d H:i A') }}</div>
                                                      ...
                                                      <div id="collapse{{ $i }}" class="accordion-collapse collapse" aria-labelledby="heading{{ $i }}" data-bs-parent="#orderAccordion">
                                                            <div class="accordion-body">
                                                                                    ...
                                                                                    <tbody>
                                                                                          ...
                                                                                          <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                      ...
                                                                                                      {{ App\Models\ProductOption::find($key)->name }}: {{ App\Models\OptionDetail::find($value)->name }} <br>
                                                                                                      @endforeach
                                                                                                      @endforeach
                                                                                                </td>
                                                                  ...
                                                                  @foreach($orders[$i]->payments as $payment)
                                                                              ...
                                                                              <div class="row">
                                                                                    ...
                                                                                    <div class="col-6">
                                                                                          <ul class="list-group">
                                                                                                ...
                                                                                                @else
                                                                                                <?php $paymentMethod = auth()->guard('student')->user()->findPaymentMethod($payment->stripe_payment_method_id) ?>
